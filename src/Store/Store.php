...
namespace Brunoinds\CurrencyGetGetApiLaravel\Store;
...
class StoreLaravelCache
{
    ...
    public function get()
    {
        return Cache::store($this->store)->get('Brunoinds/CurrencyGetGetApiLaravelStore');
    }

    public function set(string $value)
    {
        Cache::store($this->store)->put('Brunoinds/CurrencyGetGetApiLaravelStore', $value);
    }
}
